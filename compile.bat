...
javac -encoding UTF-8 -cp "lib\mysql-connector-j.jar" --release 21 -d bin src\common\Mensaje.java src\server\Seguridad.java src\server\GestorBD.java src\server\Servidor.java src\server\ManejadorCliente.java src\client\Cliente.java
if %ERRORLEVEL% EQU 0 (
    echo.
